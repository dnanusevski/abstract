...
var TemplateControl = /*#__PURE__*/function () {
  function TemplateControl() {
    _classCallCheck(this, TemplateControl);
    this.count = 1;
  }
  _createClass(TemplateControl, [{
    key: "addTemplate",
    value: function addTemplate() {
      ...
      this.count++;
      var htmlAppend = "";
      var template = "template_" + this.count;
      var default_template_1 = "default_template_" + this.count;
      htmlAppend += "<br/>";
      htmlAppend += "<label for=\"".concat(template, "\">");
      htmlAppend += "<span>Default</span>";
      htmlAppend += "<input type=\"radio\" id=\"".concat(default_template_1, "\" name=\"default_tamplate\" value=\"").concat(template, "\">");
      htmlAppend += "</label>";
      htmlAppend += "<textarea name =\"".concat(template, "\">").concat(template, "</textarea>");
...
if (document.getElementById("send_mail")) {
  document.getElementById("send_mail").onclick = function jsFunc() {
    ...
    var driver = JSON.parse(document.getElementById("driver").value);
